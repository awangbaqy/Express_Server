...
<div id="ModalTambah" class="modal fade" role="dialog">
    ...
    <?php echo form_open('DataKategori/store') ?>
                <fieldset>
...
<?php if(isset($data)) { ?>
									<tbody>
										...
										<td>
                                            <!-- Tombol Modal Ubah-->
                                            <button type="button" class="btn btn-info btn-sm glyphicon glyphicon-pencil" data-toggle="modal" data-target="#ModalUbah<?php echo $row->id_kategori ?>"></button>

<!-- Modal Ubah -->
<div id="ModalUbah<?php echo $row->id_kategori ?>" class="modal fade" role="dialog">
    <div class="modal-dialog">
...
<!-- Tutup Modal Ubah -->
											...
											<a href="<?php echo site_url('DataKategori/destroy/'.$row->id_kategori) ?>" type="button" class="btn btn-danger btn-sm glyphicon glyphicon-trash"
